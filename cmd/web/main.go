...
import (
	...
	"github.com/aziderius/bookings-go/internal/handlers"
...
//type this command in root folder to run the app vvvvvv
...
func run() (*driver.DB, error) {
	...
	db, err := driver.ConnectSQL("host=localhost port=5432 dbname=bookings user=postgres password=admin13")
	if err != nil {
